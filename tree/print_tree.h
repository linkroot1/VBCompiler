...
void parceDeclarationStatement(DeclStmt* declStmtMulti, Tree* tree, int parentNum);
void parceDeclarationStatement(DeclStmt* declStmtMulti, Tree* tree, int parentNum);
void parceVarName(VarName* varNameMulti, Tree* tree, int parentNum);
void parceVarName(VarName* varNameSingle, Tree* tree, int parentNum);
